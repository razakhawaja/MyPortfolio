  ...
  return (
    <>
      ...
      <div className="grid grid-rows-2 md:grid-cols-3 gap-4 md:gap-12">
        ...
        <div
          className="place-self-center cursor-pointer transition duration-500 transform hover:-translate-y-2 hover:text-primary-hover tailwind-hidden md:block"
          onClick={(e) => {
            e.preventDefault();
        ...
        <div
          className="place-self-center md:place-self-end inline-flex cursor-pointer transform hover:translate-x-4 hover:text-primary-hover transition duration-500"
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          ...
          <ChevronRight className="flex-shrink-0 hover:text-primary-hover" />
        </div>
      </div>
    </>
  );
